  ...
  <div className="layout-container">
    ...
    >
      ...
      <ul className="menu-inner py-1">
        ...
        <li className="menu-item">
          <a href="/dashboard/produits" className="menu-link">
            <i className="menu-icon tf-icons bx bx-home-circle" />
            <div data-i18n="Analytics">Produits</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="/dashboard/article" className="menu-link">
            <i className="menu-icon tf-icons bx bx-home-circle" />
            <div data-i18n="Analytics">Article</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="/dashboard/Commande" className="menu-link">
            <i className="menu-icon tf-icons bx bx-home-circle" />
            <div data-i18n="Analytics">Commande</div>
          </a>
        </li>
