...
const Commande = () => {
    ...
    return (
      <div className="container-xxl flex-grow-1 container-p-y">
         <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span>COMMANDE</h4>
         <center>
         <div style={{marginBottom:'10px'}}>
         <a type="button" href='/dashboard/createCommande' class="btn btn-success">AJOUTER UNE COMMANDE</a>
         </div>
         </center>
