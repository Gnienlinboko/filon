...
const Produits = () => {
    ...
    return (
      <div className="container-xxl flex-grow-1 container-p-y">
         <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span>Produits</h4>
         <center>
         <div style={{marginBottom:'10px'}}>
         <a type="button" href='/dashboard/createProduit' class="btn btn-success">AJOUTER UN PRODUIT</a>
         </div>
         </center>
